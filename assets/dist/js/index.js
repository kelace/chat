(function () {
	...
	function (_EventEmitter) {
	  _inherits(OffersComponent, _EventEmitter);
	  ...
	  function OffersComponent() {
	    ...
	    _this = _possibleConstructorReturn(this, _getPrototypeOf(OffersComponent).call(this));
	    _this.offersBlock = document.querySelector(".side__offers");
	  ...
	  _createClass(OffersComponent, [{
	    key: "addOffer",
	    value: function addOffer(newElement) {
	      this.offersBlock.appendChild(newElement);
	    }
	  }, {
	    key: "removeOffer",
	    value: function removeOffer() {}
	  }, {
	    key: "createOffer",
	    value: function createOffer(data) {
	      var offerBlock = document.createElement("div");
	      var name = document.createElement("div");
	      var buttonAccept = document.createElement("button");
	      var buttonDeclined = document.createElement("button");
	    ...
	    key: "offerReceived",
	    value: function offerReceived(data) {
	      var offerElement = this.createOffer(data);
	    ...
	    value: function bindViewEvents() {
	      ...
	      if (this.offersBlock) {
	        this.offersBlock.addEventListener("click", function (e) {
	          e.preventDefault();

	          if (e.target.tagName === "BUTTON") {
	            var parentEl = e.target.parentElement;
	            var name = parentEl.getAttribute('data-user-name');
	            var id = parentEl.getAttribute('data-user-id');
	...
	/*#__PURE__*/
	function (_EventEmitter) {
	  _inherits(UsersComponent, _EventEmitter);
	  ...
	  function UsersComponent() {
	    ...
	    _this = _possibleConstructorReturn(this, _getPrototypeOf(UsersComponent).call(this));
	    _this.el = document.querySelector(".side__users");
	...
	/*#__PURE__*/
	function (_EventEmitter) {
	  _inherits(messagesComponent, _EventEmitter);
	  ...
	  function messagesComponent(messages) {
	    ...
	    _this = _possibleConstructorReturn(this, _getPrototypeOf(messagesComponent).call(this));
	    _this.el = _this.createElement(messages);
	    return _this;
	  }

	  _createClass(messagesComponent, [{
	    key: "createElement",
	    value: function createElement(messages) {
	...
	/*#__PURE__*/
	function (_EventEmitter) {
	  _inherits(ChatComponent, _EventEmitter);

	  function ChatComponent(users) {
	    var _this;

	    _classCallCheck(this, ChatComponent);

	    _this = _possibleConstructorReturn(this, _getPrototypeOf(ChatComponent).call(this));
	    _this.el = document.querySelector(".chat");
	    _this.messages = {};
	    _this.users = users;
	    _this.currentSpeakerId = null;
	    return _this;
	  }
	  ...
	  _createClass(ChatComponent, [{
	    ...
	    key: "requestMessages",
	    value: function requestMessages(id) {
	      var idFriend = id;
	      var url = "/get-messages/" + id;
	      console.log(url);
	    ...
	    key: "sendMessage",
	    value: function sendMessage(id, text) {
	      var _this2 = this;

	      var url = "/send-message/" + id;
	      console.log(id);
	      $.ajax({
	        url: url,
	        type: "POST",
	    ...
	    value: function render(id) {
	      ...
	      chatForm.addEventListener("submit", function (e) {
	        e.preventDefault();
	        var text = e.target.textform.value;
	        console.log(text);
	...
	/*#__PURE__*/
	function (_EventEmitter) {
	  _inherits(AuthComponent, _EventEmitter);
	  ...
	  function AuthComponent() {
	    ...
	    _this = _possibleConstructorReturn(this, _getPrototypeOf(AuthComponent).call(this));
	    _this.authBlock = document.querySelector(".auth-block");
	    _this.tabButtons = document.querySelector(".tabs");
	    _this.currentTab = document.querySelector(".tabs__button.active");
	    _this.currentForm = document.querySelector(".form_auth.active");
	    _this.registerError = document.querySelector(".register-js .errors-line");
	    _this.loginError = document.querySelector(".login-js .errors-line");
	    _this.logOutView = document.querySelector(".logout-js");
	  ...
	  _createClass(AuthComponent, [{
	    key: "tabsHandler",
	    value: function tabsHandler() {
	      var _this2 = this;

	      if (this.tabButtons) {
	        this.tabButtons.addEventListener("click", function (e) {
	          e.preventDefault();

	          if (!e.target.classList.contains("tabs__button") && e.target.classList.contains("active")) {
	            return;
	          }

	          _this2.currentTab.classList.remove("active");

	          _this2.currentTab = e.target;

	          _this2.currentTab.classList.add("active");

	          _this2.currentForm.classList.remove("active");

	          _this2.currentForm = document.querySelector(_this2.currentTab.getAttribute("href"));

	          _this2.currentForm.classList.add("active");
	    ...
	    value: function submitHandler() {
	      ...
	      var registerForm = document.querySelector(".register-js");
	      ...
	      if (registerForm) {
	        registerForm.addEventListener("submit", function (e) {
	          ...
	          if (e.currentTarget.elements.confirm.value !== e.currentTarget.elements.password.value) {
	            _this3.registerError.innerText = "Пароли не совпадают";

	            _this3.registerError.classList.remove("error_hidden");
	          ...
	          for (var i = 0; i < inputs.length; i++) {
	            if (!inputs[i].value.length) {
	              _this3.registerError.innerText = "Пустые поля";
	          ...
	          $.ajax({
	            ...
	            error: function error(err) {
	              console.log(err);
	              _this3.registerError.innerText = err.responseJSON.title;
	    ...
	    value: function loginSubmit() {
	      ...
	      var loginrForm = document.querySelector(".login-js");

	      if (loginrForm) {
	        loginrForm.addEventListener("submit", function (e) {
	          var inputs = e.currentTarget.elements;
	          e.preventDefault();

	          if (!e.currentTarget.elements.name.value.length) {
	            _this4.loginError.innerText = "Пустые поля";

	            _this4.loginError.classList.remove("error_hidden");
	          ...
	          $.ajax({
	            ...
	            error: function error(_error) {
	              _this4.loginError.innerText = _error.responseJSON.message;
	    ...
	    key: "inputsFocus",
	    value: function inputsFocus() {
	      var _this5 = this;

	      if (this.authBlock) {
	        this.authBlock.addEventListener("click", function (e) {
	...
	function () {
	  function SearchComponent() {
	    ...
	    this.elem = document.querySelector(".side__search-result"), this.bindEvents();
	  }

	  _createClass(SearchComponent, [{
	    key: "sendRequest",
	    value: function sendRequest(buttonView, data) {
	      $.ajax({
	        type: "POST",
	        url: data,
	    ...
	    key: "createButton",
	    value: function createButton(href) {
	      var _this = this;

	      var button = document.createElement("button");
	      button.setAttribute("href", "/offer-friend?user_id=".concat(href));
	      ...
	      button.addEventListener("click", function (e) {
	        ...
	        _this.sendRequest(button, button.getAttribute("href"));
	      });
	      return button;
	    }
	  }, {
	    key: "addFindedUsers",
	    value: function addFindedUsers(users) {
	      var view = this.elem;
	      this.removeAll();
	    ...
	    value: function bindEvents() {
	      ...
	      if (this.inputView) {
	        this.inputView.addEventListener("input", function (e) {
	          if (_this2.inputModel.isResponded) {
	            _this2.inputModel.isResponded = false;

	            _this2.requestUser($(e.currentTarget).serialize());
	          }
	        });
	      }
	    }
	    ...
	    key: "requestUser",
	    value: function requestUser(value) {
	      var _this3 = this;
	      ...
	      $.ajax({
	        ...
	        url: "/find-users",
	        success: function success(data) {
	          _this3.inputModel.isResponded = true;

	          _this3.addFindedUsers(data.users);
	        }
	      });
	    }
	  }]);
	...
	var authBlock = new AuthComponent();
	var chat = new ChatComponent(state.users);
	var userSide = new UsersComponent(state.users);
	var offers = new OffersComponent();
